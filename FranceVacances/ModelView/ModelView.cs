...
namespace FranceVacances.ModelView
{
    class ModelView
    {
        ...
        public ModelView ()
        {
            ...
            Rentals.Add(new RentalModel(2,"Hotel 2", "France", 150.32, 32, address, null, "winter", 3, "Something asdasfasf fssfasg sfas fasfg asf agasfa fagsdfsa fsadfas fgasda asfs", null, "http://explorationsltd.com/wp-content/uploads/2013/04/lefaypool.jpg", null));
